---
name: pkm-reorg
description: Audit and (with approval) reorganize a VS Code workspace into a durable PARA-plus-knowledge-layer PKM system, following a strict audit-first, approval-gated, git-aware migration process. Use when the user asks to reorganize, restructure, or redesign the workspace's file/folder organization for long-term knowledge management, not for a routine code refactor.
---
