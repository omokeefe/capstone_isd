...
- **Hold citations to a real standard.** A claim attributed to a source should match what
  that source's summary/rating in `evidence/source-register.md` actually says —
...
- Ground critique in this project's own stated standards first (`CLAUDE.md`,
  `README.md`'s Working Assumptions, `projects/nas-sos-capstone/to-do-list.md`'s section
  intent) before reaching for generic SE/MBSE best practice — the student is accountable
  to the project they defined, not an abstract ideal.
