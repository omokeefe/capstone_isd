...
starting point for `to-do-list.md` §7 ("Stakeholder and Responsibility
...
[workflows/objective-ontology-pass.md](../../workflows/objective-ontology-pass.md)._
...
shared authority. Track progress on this in `projects/nas-sos-capstone/task-board.md`.
